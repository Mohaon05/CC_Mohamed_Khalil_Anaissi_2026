...
namespace trabalho_kaneko.Pages
{
    public class FornecedoresEditarModel : PageModel
    {
        ...
        public FornecedoresEditarModel(FornecedorRepository fornecedorRepository, CidadeRepository cidadeRepository, EstadoRepository estadoRepository, PaisRepository paisRepository)
        {
