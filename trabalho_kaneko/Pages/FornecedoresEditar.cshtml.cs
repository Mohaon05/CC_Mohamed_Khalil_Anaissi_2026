...
namespace trabalho_kaneko.Pages
{
    public class FornecedoresEditarModel : PageModel
    {
        ...
        public FornecedoresEditarModel(
        ...
        {
            // Busca o fornecedor específico pelo ID para preencher os campos da tela
        ...
        public IActionResult OnPost()
        {
            ...
            TempData["MensagemErro"] = "Erro ao atualizar o Fornecedor. Verifique se o CNPJ/CPF já não está em uso.";
            CarregarListas();
            return Page();
        }
